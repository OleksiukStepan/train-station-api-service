...
SECRET_KEY = "django-insecure-6&$*iydqrttdf4_9u#wt(n(v!=zm(!-aga9&bq38c@@168jhx2"
...
ROOT_URLCONF = "train_station_core.urls"
...
WSGI_APPLICATION = "train_station_core.wsgi.application"
